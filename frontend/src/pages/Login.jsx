    ...
    <div style={s.page}>
      <div style={s.container}>
        <div style={s.header}>
          ...
          <div style={s.subtitle}>AI-Powered Ham Radio Logbook</div>
        </div>
        ...
        <form style={s.form} onSubmit={handleSubmit}>
          ...
          <div style={s.fieldGroup}>
            <label style={s.label} htmlFor="email">E-MAIL / CALLSIGN</label>
            <input
              id="email"
              type="email"
              autoFocus
          ...
          >
            {loading
              ? <><span style={{ width: 14, height: 14, border: '2px solid #1e2d3d', borderTopColor: '#39d353', borderRadius: '50%', display: 'inline-block', animation: 'spin 0.7s linear infinite' }} /> Authenticating...</>
              : '→ Login'}
          </button>

          <div style={s.footer}>
            No account?{' '}
            <Link to="/register" style={{ color: '#39d353' }}>Register operator</Link>
          </div>
        </form>
      </div>
    </div>
